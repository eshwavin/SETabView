...
@available(iOS, obsoleted: 1.4.0, renamed: "SETabViewController")
open class SEViewController { }

@available(iOS, obsoleted: 1.4.0, renamed: "SETabItemProvider")
public protocol SETabItem { }

public extension SETabViewController {
    @available(iOS, obsoleted: 1.4.0, message: "Use setTabColors(backgroundColor:ballColor:tintColor:unselectedItemTintColor:barTintColor:) instead")
    ...
    @available(iOS, obsoleted: 1.4.0, message: "Use setViewControllers(_:) instead")
