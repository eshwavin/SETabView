...
class SELayer: CALayer {
    ...
    func highlight() {
        let highlightAnimation = SELayerAnimationProvider.getBackgroundChangeAnimation(runningFor: SETabSettings.current.changeTintColorAnimationDuration, toValue: SETabSettings.current.selectedTabTintColor.cgColor, timingFunction: SETimingFunction.seEaseInOut, fillMode: .both, isRemovedOnCompletion: false)
    ...
    func removeHighlight() {
        let removeHighlightAnimation = SELayerAnimationProvider.getBackgroundChangeAnimation(runningFor: SETabSettings.current.changeTintColorAnimationDuration, toValue: SETabSettings.current.deselectedTabTintColor.cgColor, timingFunction: SETimingFunction.seEaseInOut, fillMode: .both, isRemovedOnCompletion: false)
