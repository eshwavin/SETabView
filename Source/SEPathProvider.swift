...
class SEPathProvider {
    
    public static func getHolePath(for bounds: CGRect, startOffset: CGFloat, coverOffset: CGFloat, itemWidth: CGFloat, sectionHeight: CGFloat, heightScalingFactor: CGFloat) -> CGPath {
    ...
    public static func getInvertedPlateauPath(for bounds: CGRect, startOffset: CGFloat, coverOffset: CGFloat, itemWidth: CGFloat, sectionHeight: CGFloat, heightScalingFactor: CGFloat) -> CGPath {
    ...
    public static func getRectangularMorphForPlateau(for bounds: CGRect, startOffset: CGFloat, coverOffset: CGFloat, itemWidth: CGFloat, sectionHeight: CGFloat) -> CGPath {
    ...
    public static func getBumpMorph(for bounds: CGRect, startOffset: CGFloat, coverOffset: CGFloat, itemWidth: CGFloat, sectionHeight: CGFloat, heightScalingFactor: CGFloat)  -> CGPath {
    ...
    public static func createRotateBallPaths(forSelectedIndex selectedTabIndex: Int, previousTabIndex: Int, sectionWidth: CGFloat, ballLayerYPosition: CGFloat) -> [String: CGPath] {
